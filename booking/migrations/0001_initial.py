    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotel_history', to='booking.hotel')),
            ],
        ),
        migrations.CreateModel(
            name='FavoriteHotel',
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_hotel', to='booking.hotel')),
            ],
        ),
        migrations.AddField(
            model_name='booking',
            name='booking_hotel',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booking_hotel', to='booking.hotel'),
        ),
        migrations.CreateModel(
            name='Room',
            fields=[
                ...
                ('hotels_room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='room_numbers', to='booking.hotel')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_hotels', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books_hotels', to='booking.hotel')),
