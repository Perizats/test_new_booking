    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ManyToManyField(related_name='hotel', to='booking.country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='hotel_history', to='booking.hotel')),
            ],
        ),
        migrations.CreateModel(
            name='FavoriteHotel',
        ...
        migrations.AddField(
            model_name='booking',
            name='book_hotel',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_hotel', to='booking.hotel'),
        ),
        migrations.CreateModel(
            name='Room',
            fields=[
