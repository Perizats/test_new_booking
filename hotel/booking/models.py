...
class Hotel(models.Model):
    ...
    country = models.ManyToManyField(Country, related_name='hotel')
...
class FavoriteHotel(models.Model):
    favorite = models.ForeignKey(Country, on_delete=models.CASCADE, related_name='favorite_hotels')
...
class Booking(models.Model):
    booking_user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='booking')
...
class History(models.Model):
    user = models.OneToOneField(Profile, on_delete=models.CASCADE, related_name='user_history')
    hotel = models.OneToOneField(Hotel, on_delete=models.CASCADE, related_name='hotel_history')
    history_date = models.OneToOneField(Booking, on_delete=models.CASCADE, related_name='date_history')
    history_price = models.OneToOneField(Booking, on_delete=models.CASCADE, related_name='price_history')

    def __str__(self):
        return f'{self.hotel}, {self.history_date}, {self.history_price}'
...
class Book(models.Model):
    ...
    book_image = models.ForeignKey(RoomImage, on_delete=models.CASCADE, related_name='books_hotels')
